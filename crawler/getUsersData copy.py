...
def getData(edge, userData):
    ...
    if edge['node']['is_video']:
        ...
        userData['data'][timestamp]['display_url'] = edge['node']['display_url']
...
if __name__ == '__main__':
    ...
    # usersUrlsFile = "D:\\g1080265\\instagram\\usersUrls.json"
    ...
    for user in userNames:
        ...
        try:
            ...
            #             urlData['video_url'] = usersData[user]['data'][timestamp]['video_url']
            #         else:
            #             urlData['is_video'] = False
            #             urlData['display_url'] = usersData[user]['data'][timestamp]['display_url']
