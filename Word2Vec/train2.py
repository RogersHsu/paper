...
class Train(object):
	...
	def train(self):
		...
		model = word2vec(sentence, size = 100, window = 5, min_count = 5, sg=1, workers=8)
		# Save model
		model.wv.save_word2vec_format(u"D:\\word2vec\\model\\zhfn100w5m5sg1.model.bin", binary = True)
		print("model1 已儲存完畢")
