...
class Train(object):
	...
	def train(self):
		...
		model = Word2Vec(sentence, size = 300, window = 5, min_count = 5, iter=5, workers = 8)
		# Save model
		model.wv.save_word2vec_format(u"D:\\word2vec\\model\\zhfn300w5m5it5.model.bin", binary = True)
		print("model1 已儲存完畢")
